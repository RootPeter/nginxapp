#define NGX_CONFIGURE " --user=www --group=www --prefix=/usr/local/nginx --with-http_stub_status_module --with-http_ssl_module --with-http_v2_module --with-http_gzip_static_module --with-http_sub_module --with-stream --with-stream_ssl_module --with-openssl=/root/lnmp1.7/src/openssl-1.1.1g --with-openssl-opt='enable-weak-ssl-ciphers' --with-ld-opt=-Wl,-rpath,/usr/local/luajit/lib --add-module=/root/lnmp1.7/src/lua-nginx-module-0.10.14 --add-module=/root/lnmp1.7/src/ngx_devel_kit-0.3.1 --add-module=/root/app/headers-more-nginx-module-0.33 --add-module=/root/app/nginx_upload_module --add-module=/root/app/ngx_brotli --add-module=/root/app/ngx_cache_purge-2.3 --add-module=/root/app/ngx_http_substitutions_filter_module-0.6.4"
